...
local function run(msg, matches)
  if matches[1]:lower() == 'spamkiller' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "spamkiller" then -- Put everything you like :)
...
return {
  patterns = {
    "^[!/]([Ss]tats)$",
    "^[!/]([Ss]pamkiller)$",
    "^[!/]([Ss]pamkiller) (group) (%d+)",
    "^[!/]([Ss]pamkiller) (pamkiller)",-- Put everything you like :)
		"^[!/]([Ss]pamkiller)"-- Put everything you like :)
    }, 
  run = run
}
